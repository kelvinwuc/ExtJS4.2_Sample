...
public class Encryption
   ...
   /* constructor */
	...
	public Encryption(String strThisHashAlgorithms)
	{
   ...
   public static void main(String[] args)
	...
	public String encryptPassword( String strPassword )
	{
		...
		byte[] buf= new byte[strPassword.length()];
		buf = strPassword.getBytes();

		MessageDigest algorithm=null;
		try 
		{
			algorithm = MessageDigest.getInstance(strHashAlgorithms);
			algorithm.reset();
			algorithm.update(buf);
			byte[] digest1 = algorithm.digest();
			strEncryptedPassword = encode( digest1 );
		}
		catch (NoSuchAlgorithmException e) 
		{
			strEncryptedPassword = null;
		}
