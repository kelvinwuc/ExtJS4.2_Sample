...
Calendar.prototype.show = function() {
	...
	this.gWinCal.document.open("/CashWeb/blank.html");
...
//	this.wwriteA(this.gMonthName + " " + this.gYear);
	this.wwriteA( "民國"+(parseInt(this.gYear)-1911)+ "年" + this.gMonthName);
	this.wwriteA("</B><BR>");
...
//		this.wwrite(this.gMonthName + "/" + this.gYear + "<BR>");
		this.wwrite( (parseInt(this.gYear) - 1911) + "年" + this.gMonthName + "<BR>");
		this.wwrite(vCode);
...
Calendar.prototype.format_data = function(p_day) {
	...
	var vY3 = new String(parseInt(this.gYear)-1911);
	
	vY3 = (vY3.length<3)?"0"+vY3:vY3;
...
//R00393 edit by Leo Huang start
	p_item = arguments[0];//回填之Text

	
	if (arguments[2] == null||arguments[2] == "")//Year
		p_year = new String(gNow.getFullYear());
	else{
		p_year = arguments[2];
		gNow.setFullYear(arguments[2]);
		}
		
		
	if (arguments[3] == "" || arguments[3] == null)//Month
		p_month = new String(gNow.getMonth());
	else{
		p_month = arguments[3];
		gNow.setMonth(arguments[3]);
		}
		
	if (arguments[4] != "" || arguments[4] != null)//Date
	{
		gNow.setDate(arguments[4]);
	}
...
//		p_format = "MM/DD/YYYY";
	...
	vWinCal = window.open(arguments[1]+"/blank.html", "Calendar", 
...
function show_yearly_calendar(p_item, p_year, p_format) {
	...
	var vWinCal = window.open("/CashWeb/blank.html", "Calendar", "scrollbars=yes");
	vWinCal.opener = self;
	ggWinCal = vWinCal;
