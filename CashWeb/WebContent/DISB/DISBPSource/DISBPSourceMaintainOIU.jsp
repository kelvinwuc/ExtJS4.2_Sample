 ...
 * 
 * 
 * Revision 1.01  2015/09/22 Kelvin Wu
 * RD0382－OIU專案
 *  
 */
%>
...
log.info("DISBPSourceMaintainOIU.jsp running...");
%>
<%! String strThisProgId = "DISBPSourceMaintOIU"; //本程式代號 %><%
...
<BODY ONLOAD="WindowOnLoad();">
	<form action="<%=request.getContextPath()%>/servlet/com.aegon.disb.disbpsource.DISBSMaintainOIUServlet" id="frmMain" name="frmMain" method="post">
